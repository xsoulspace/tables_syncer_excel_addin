...
class _$_AdPermissions extends _AdPermissions {
  const _$_AdPermissions({this.adsAllowed = false}) : super._();
  ...
  @override
  String toString() {
    return 'AdPermissions(adsAllowed: $adsAllowed)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, adsAllowed);
...
abstract class _AdPermissions extends AdPermissions {
  const factory _AdPermissions({final bool adsAllowed}) = _$_AdPermissions;
