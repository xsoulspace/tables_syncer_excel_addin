...
class _$_AppSettingsModel extends _AppSettingsModel {
  ...
  @override
  String toString() {
    return 'AppSettingsModel(locale: $locale, themeMode: $themeMode)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(locale), themeMode);
...
abstract class _AppSettingsModel extends AppSettingsModel {
  const factory _AppSettingsModel(
      {@JsonKey(fromJson: localeFromString, toJson: localeToString)
          final Locale? locale,
      final ThemeMode themeMode}) = _$_AppSettingsModel;
